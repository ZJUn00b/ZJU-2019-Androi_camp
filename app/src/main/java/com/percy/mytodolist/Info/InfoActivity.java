package com.percy.mytodolist.Info;
...
import com.percy.mytodolist.MainActivity;
import com.percy.mytodolist.NoteActivity;
import com.percy.mytodolist.R;
import com.percy.mytodolist.write.WriteActivity;
...
public class InfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button WriteBtn = findViewById(R.id.write_file);

        WriteBtn.setOnClickListener(new View.OnClickListener() {
            private static final int REQUEST_CODE_WRITE= 2002;
            @Override
            public void onClick(View v) {
                startActivityForResult(
                        new Intent(InfoActivity.this, WriteActivity.class),
                        REQUEST_CODE_WRITE);
            }
        });
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == 2002 && resultCode == 2)
        {
            ...
            Toast.makeText(com.percy.mytodolist.Info.InfoActivity.this,
