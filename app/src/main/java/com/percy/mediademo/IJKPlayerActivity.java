...
import com.percy.mediademo.player.VideoPlayerIJK;
import com.percy.mediademo.player.VideoPlayerListener;
    ...
    private void init() {
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                handler.sendEmptyMessageDelayed(MSG_REFRESH, 100);//100ms更新进度条
            }
        });
        /*---------------------------------------------------------------------------------------------------*/
        //TODO: 加入音量控制
        s1.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                //停止拖动
                ijkPlayer.seekToVol(s1.getProgress() / 100f);
                handler.sendEmptyMessageDelayed(MSG_REFRESH, 100);//100ms更新进度条
            }
        });
