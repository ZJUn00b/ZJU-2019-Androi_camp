package com.percy.minidouyin.camera;
...
import com.percy.minidouyin.shutton.TouchButton;
import com.percy.minidouyin.util.ContentUriUtil;
import com.percy.minidouyin.util.Utils;
import com.percy.minidouyin.R;
import com.percy.minidouyin.view.ui.MainActivity;
...
import static com.percy.minidouyin.util.Utils.MEDIA_TYPE_IMAGE;
import static com.percy.minidouyin.util.Utils.MEDIA_TYPE_VIDEO;
import static com.percy.minidouyin.util.Utils.getOutputMediaFile;
...
public class CustomCameraActivity extends AppCompatActivity {
    ...
    private void releaseMediaRecorder() {
        ...
        mMediaRecorder.stop();
        File mfile = getOutputMediaFile(MEDIA_TYPE_VIDEO);
...
//        Uri VideoUri =Uri.fromFile(new File(ContentUriUtil.getPath(CustomCameraActivity.this, VideoUri_raw)));
        //把返回数据存入Intent
        setResult(RESULT_OK, new Intent().setData(VideoUri_raw));
        finish();
